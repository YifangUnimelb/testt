...
# A posterior mean
round(bvar_est(Y_rw,X_rw)$A.E,2)
# Sigma posterior mean
round(bvar_est(Y_rw,X_rw)$Sigma.E,2)
...
# A posterior mean
round(apply(bvar_t(Y_rw,X_rw)$A.posterior.draws[,,1:1000], 1:2, mean),2)
# Lambda posterior mean
round(mean(bvar_t(Y_rw,X_rw)$lambda.posterior.draws[,1:1000]),2)
# Sigma posterior mean
round(mean(bvar_t(Y_rw,X_rw)$lambda.posterior.draws[,1:1000]),2)*round(apply(bvar_t(Y_rw,X_rw)$Sigma.posterior.draws[,,1:1000],1:2, mean),2)
