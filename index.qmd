...
cpi.fact.log
as.matrix(point.f.cpi)[1,]
as.matrix(point.f.cpi.t)[1,]
as.matrix(point.f.cpi.sv)[1,]
...
plot(as.matrix(cr.fact[,2]), type='l',ylim=c(2, 5), col= mcxs3, ylab='value', xlab='step', main='Bivariate Random Walk' )
lines(as.matrix(point.f.cr)[1:3])
